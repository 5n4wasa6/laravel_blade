...
<div class="panel-body">
    ...
    <div class="panel panel-default"> 
        <form  enctype="multipart/form-data" action="{{ url('triathlon_event_store') }}" method="POST">
            {{ csrf_field() }}
    ...
    @foreach ($all_events as $all_event)
        <div class="panel panel-default">
            <div class="panel-body">
                @if ($all_event->user_id == $auths->id)
                    <div class="discussion_editdelete">
                        ...
                        <!-- 削除ボタン -->
                        <div>
                            <form action="{{ url('triathlon_events/'.$all_event->id) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                ...
                <!--参加可否ボタン-->
                <form action="{{ url('triathlon_participate_store') }}" method="GET">
            ...
            <div class="panel-footer">
                <form action="{{ url('/triathlon_event_comment') }}" method="POST">
                {{ csrf_field() }}
