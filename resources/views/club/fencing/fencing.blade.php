...
{{ csrf_field() }}
    ...
    <div class="panel panel-default">  
        <form  enctype="multipart/form-data" action="{{ url('fencingdiscuss') }}" method="POST">
            {{ csrf_field() }}
    ...
    @foreach ($alls as $all)
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                @if ($all->user_id == $auths->id)
                    <div class="discussion_editdelete">
                        ...
                        <!-- 削除ボタン -->
                        <div>
                            <form action="{{ url('fencing_discussions/'.$all->id) }}" method="POST">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
            ...
            <div class="panel-footer">    
                <form action="{{ url('fencing_discussion_comment') }}" method="POST">
                {{ csrf_field() }}
